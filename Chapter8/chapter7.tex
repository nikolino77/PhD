...
Given the large variation in the output signal of the MCP it is not possible to select event by event on a pulse shape analysis method.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=6cm]{../Pictures/Chapter_8/interaction_time_spectrum.png}
\includegraphics[width=6cm]{../Pictures/Chapter_8/electron_drift.png}
\end{center}
\caption[]{}
\label{fig:drift}
\end{figure}
...
This phenomenon can be experimentally shown by selectively suppress one of the two processes. The setup was then slightly changed by titlting the MCP-PMT with repsect to the start-source system.
\begin{figure}[htbp]
\begin{center}
...
\label{fig:twist1}
\end{figure}
Then a lead screen was placed in between and two set of measurements was performed, as shown in figure \fig{ref:twist1}:
\begin{itemize}
