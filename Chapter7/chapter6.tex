...
In order to quantify the IRF, the standard procedure is to directly hit the photo detector with the laser light and measure the delay spectrum with respect to the trigger signal of the laser.
...
The measured IRF is deconvolved from the measured signal via the method described in the previous chapter.
...
A toy model was used to examine the range influence, that is a bi exponential curve with a rise time of 36 ps and a decay time of 33 ns. 
...
As an example of parameter determination, the case for a LSO Sipat in figure \ref{fig:likelihood_sipat} crystal is shown. In this case, for a bi exponential fit with one component decay, we will quote the values, with relative asymmetric confidence level $\tau _{r} = 36_{-30}^{+27}$ ps and $\tau _{d}= 40.5_{-0.9}^{+0.7}$.
\begin{figure}[htbp]
\begin{center}
...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=9cm]{../Pictures/Chapter_7/CTI.png}
%\includegraphics[width=9cm]{../Pictures/Chapter_7/ca_ce.png}
%\end{center}
...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=9cm]{../Pictures/Chapter_7/lgso.png}
%\includegraphics[width=9cm]{../Pictures/Chapter_7/cef3.png}
%\end{center}
...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=8cm,height=6.5cm]{../Pictures/Chapter_7/bgo.png}
%\end{center}
...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=8cm,height=6.5cm]{../Pictures/Chapter_7/luag_0_0_8.png}
%\end{center}
...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=8cm,height=6.5cm]{../Pictures/Chapter_7/2612.png}
%\includegraphics[width=8cm,height=6.5cm]{../Pictures/Chapter_7/0_44.png}
%\end{center}
