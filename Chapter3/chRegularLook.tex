...
Finally a passivation layer (SiO2) protects the device. Due to its low index of refraction (n $=1.55$ in the blue) with respect to the one of Silicon (n$=3.5$) Fresnel losses can occur, usually compensated by the presence of anti-reflection coatings.
...
The chip has eight channels, designed for differential readout. Each channel is characterized by an amplifier with 1-ns peaking time, a discriminator with a minimum detection threshold of 10 fC and an output stage.
